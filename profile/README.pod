...
<!-- LOGO -->
<header>
  <img alt="Zeppe-Lin" class="logo" src="/images/logo-big-2color.png">
</header>
...
<a href="https://github.com/zeppe-lin/pkgsrc/releases/latest">
  <img src="https://img.shields.io/github/v/release/zeppe-lin/pkgsrc?color=2c5e36&display_name=tag&label=CURRENT%20RELEASE&logo=linux&logoColor=white&style=for-the-badge" alt="Current Release">
</a>
...
if you want to build rootfs image, and
